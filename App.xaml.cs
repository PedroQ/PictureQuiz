...
namespace PictureQuiz
{
    public partial class App : Application
    {
        ...
        private void ForceDarkTheme()
        {
            ...
            ((SolidColorBrush)Resources["PhoneRadioCheckBoxCheckBrush"]).Color = Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF);
            ((SolidColorBrush)Resources["PhoneRadioCheckBoxBorderBrush"]).Color = Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF);
